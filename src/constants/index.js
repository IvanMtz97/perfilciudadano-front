...
export const POSTAL_CODE_URI = `${DEV_BASE_URI}/postalcode`;
export const LEADER_URI = `${DEV_BASE_URI}/leader`;
export const OPERATOR_URI = `${DEV_BASE_URI}/operator`;
export const COORDINATOR_URI = `${DEV_BASE_URI}/coordinator`;
